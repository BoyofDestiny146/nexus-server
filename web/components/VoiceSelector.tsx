...
/**
 * VoiceSelector — per-device voice + speed picker, shown in a centered modal.
 *
 * Renders Voice / Speed / Length, Preview, volume, test message, Test Voice,
 * power/sleep, Unbind, and Delete / Reset Device. Catalog from GET /api/voices;
 * current values from GET /api/device/{mac}/voice. Save uses PUT
 * /api/device/{mac}/voice and closes the modal only after that call succeeds.
 */
...
const selectClass =
  "bg-white border border-slate-line/80 rounded-card px-2.5 py-1.5 text-[13px] text-slate-deep tracking-tight focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/15 transition";

export function VoiceSelector({ mac, deviceId, agentId, agentName, onDeleted, open, onClose }: Props) {
  ...
  const nestedConfirmOpen = unbindOpen || deleteOpen;
  const closeBlocked = saveStatus === "saving" || unbindBusy || deleteBusy || nestedConfirmOpen;
  ...
  const title = agentName ? `Control · ${agentName}` : "Device control";
      ...
      >
        ...
        {!loadError && !catalog && (
          <div className="flex flex-col gap-3 py-1">
            ...
            <div className="skeleton h-8 w-full rounded-card" />
            ...
            <div className="flex flex-wrap items-end gap-3">
              ...
              <div className="flex flex-col gap-1 min-w-0">
                ...
                <select
                  ...
                  className={classNames(selectClass, "min-w-[140px]")}
                  aria-label="Speed"
                >
              ...
              <div className="flex items-end pb-[20px] ml-auto">
                <button
                  type="button"
                  onClick={() => playPreview()}
              ...
              <div className="flex flex-wrap items-end gap-3">
                ...
                <div className="flex flex-col gap-1 min-w-0">
                  ...
                  <select
                    ...
                    className={classNames(selectClass, "min-w-[120px]")}
                  >
                ...
                <div className="flex flex-col gap-1 min-w-0 flex-1">
                  ...
                  <select
                    ...
                    className={classNames(selectClass, "min-w-[150px]")}
                  >
                    {SLEEP_MODES.map((m) => (
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button type="button" onClick={handleUnbind} disabled={unbindBusy} className="btn-primary">
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button type="button" onClick={handleDelete} disabled={deleteBusy} className="btn-danger">
